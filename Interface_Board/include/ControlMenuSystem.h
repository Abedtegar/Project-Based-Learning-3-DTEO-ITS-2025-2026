...
enum MenuLevel {
  ...
  MENU_ESCALATOR_CONTROL, // Kontrol (speed/dir/on-off)
...
private:
  ...
  // Network manager pointer (set by main)
  NetworkManager *networkManager;

  // Previous values for partial redraw optimization
  float prevEscalatorSpeed;
  float prevEscalatorTarget;
  float prevMotorSpeed;
  bool needFullRedraw; // Flag to force full redraw on menu change
...
public:
  ...
  void updateEscalatorFromPacket(EscalatorDataPacket pkt);
